...
$Slide=Slide::all();
$CategoryProducts=CategoryProducts::find($CP);
         $Products=Products::find($P);
			...
			<div class="container">
				...
				<div class="pull-right">
					<div class="beta-breadcrumb font-large">
						<a href="HomeMA">Home</a> / <span>Product</span>
					</div>
				</div>
					...
					<div id="content">
						<div class="row">
							<div class="col-sm-9">
								...
								<div class="row">
									<div class="col-sm-4">
										<img src="images/product/{{$Products->image}}" alt="">
									</div>
									<div class="col-sm-8">
										<div class="single-item-body">
											<p class="single-item-title">{{$Products->name}}</p>
											<p class="single-item-price">
												<span>Unit Price : {{$Products->unit_price}}</span>
												<br>
												<span>Promotion Price : {{$Products->promotion_price}}</span>
											</p>
										</div>
